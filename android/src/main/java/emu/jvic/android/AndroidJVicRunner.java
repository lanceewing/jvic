...
public class AndroidJVicRunner extends JVicRunner {

    private Thread machineThread;
    
    private Machine machine;
    
    public AndroidJVicRunner(KeyboardMatrix keyboardMatrix, PixelData pixelData, SoundGenerator soundGenerator) {
    ...
    private void runProgram(AppConfigItem appConfigItem) {
        ...
        AndroidProgramLoader programLoader = new AndroidProgramLoader(pixelData);
