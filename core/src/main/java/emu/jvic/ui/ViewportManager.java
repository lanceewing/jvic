...
public class ViewportManager {
    ...
    public void update(int width, int height) {
        ...
        // TODO: This is from AGILE. Needs tweaking for JVoc.
    ...
    /**
     * Tests where the VIC screen exactly fits the width of the viewport.
     * 
     * @return
     */
    public boolean doesScreenFitWidth() {
        return !(getHeight() > (getWidth() / 1.33f));
    }

    /**
     * Calculates and returns the width of the VIC screen using the current 
     * viewport height.
     * 
     * @return
     */
    public float getVICScreenWidth() {
        return (getHeight() * 1.33f);
    }
    
    /**
     * Calculates and returns the width of the padding either side of the VIC
     * screen, when in landscape mode.
     * 
     * @return The width of the padding either side of the VIC screen.
     */
    public float getSidePaddingWidth() {
        float sidePaddingWidth = 0;
        if (doesScreenFitWidth()) {
            sidePaddingWidth = ((getWidth() - getVICScreenWidth()) / 2);
        }
        return sidePaddingWidth;
    }
    
    /**
     * Gets the Y value of the base of the VIC screen.
     * 
     * @return The Y value of the base of the VIC screen.
     */
    public int getVICScreenBase() {
        return (int)(getHeight() - (getWidth() / 1.33));
    }
